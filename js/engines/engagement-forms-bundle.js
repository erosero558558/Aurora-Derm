!(function () {
    ...
    function a(t, n) {
        return 'en' ===
            (e && 'function' == typeof e.getCurrentLang
                ? e.getCurrentLang()
                : 'es')
            ? n
            : t;
    ...
    function r(e) {
        const t = (function () {
            const e = document.getElementById('callbackStatus');
    ...
    window.PielEngagementFormsEngine = {
        init: function (c) {
            return (
                (e = c || e),
                (function () {
                    const t = document.getElementById('callbackForm');
                    t &&
                        'true' !== t.dataset.callbackEngineBound &&
                        ((t.dataset.callbackEngineBound = 'true'),
                        t.addEventListener('submit', async function (t) {
                            ...
                            try {
                                (e &&
                                    'function' ==
                                        typeof e.createCallbackRecord &&
                                    (await e.createCallbackRecord(u)),
                                    e &&
                ...
                (function () {
                    const t = document.getElementById('reviewForm'),
                        r = Array.from(
                            document.querySelectorAll('.star-rating i')
                        );
                    t && 'true' !== t.dataset.reviewEngineBound
                        ? ((t.dataset.reviewEngineBound = 'true'),
                          (o = r),
                          (n = 0),
                          o.forEach((e, t) => {
                                  ...
                                  ((n = t + 1),
                                      o.forEach((e, t) => {
                                          ...
                                          (e.classList.toggle('active', o),
                                              e.classList.toggle('fas', o),
                                              e.classList.toggle('far', !o));
                                      }));
                              });
                          }),
                          t.addEventListener('submit', async function (t) {
                              ...
                              try {
                                  const t =
                                          e &&
                                          'function' ==
                                              typeof e.createReviewRecord
                                              ? await e.createReviewRecord(u)
                                              : u,
                                      i =
                                          e &&
                                          'function' == typeof e.getReviewsCache
                                              ? e.getReviewsCache()
                                              : [],
                                      r = [
                                          t,
                                  ...
                                  (e &&
                                      'function' == typeof e.setReviewsCache &&
                                      e.setReviewsCache(r),
                                      e &&
                                          'function' ==
                                              typeof e.renderPublicReviews &&
                                          e.renderPublicReviews(r),
                                      e &&
                                          'function' == typeof e.showToast &&
                                          e.showToast(
                                              a(
