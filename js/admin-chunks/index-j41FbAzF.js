...
async function _(e, t = {}) {
    const a = (function (e, t = {}) {
            ...
            const s = o.toString();
            return `/api.php?resource=${encodeURIComponent(n)}${s ? `&${s}` : ''}`;
        })(e, t.query || {}),
        { query: n, ...i } = t || {};
    return q(a, i);
}
...
function Qe(e, t = []) {
    const a = e && 'object' == typeof e ? e : {},
        ...
        o = (function (e) {
            return je(e.callingNow).concat(je(e.calling_now));
        })(a),
        s = (function (e) {
            const t = je(e).map((e, t) => Fe(e, t));
            return {
                normalizedTickets: t,
        ...
        c = (function (e) {
            return je(e.nextTickets)
                .concat(je(e.next_tickets))
                .map((e, t) =>
                    Ke(
                        {
                            ...e,
    ...
    return {
        ...
        assistancePendingCount: Re(
            a.assistancePendingCount ??
                ...
                je(a.activeHelpRequests).filter(
                    (e) => 'pending' === String(e?.status || '').toLowerCase()
                ).length ??
                je(a.active_help_requests).filter(
                    (e) => 'pending' === String(e?.status || '').toLowerCase()
                ).length,
            0
        ),
        activeHelpRequests: je(a.activeHelpRequests).length
            ? je(a.activeHelpRequests)
            : je(a.active_help_requests),
        counts: {
...
function Ze(e) {
    ...
    for (const e of je(t.nextTickets))
...
function nt(e, t = null) {
    ...
    return [...new Set(je(e).map((e) => Number(e || 0)))]
...
function Dt() {
    ...
    const e = jt(g().queue.search);
    return (
        (Nt =
            (function () {
                try {
                    return jt(window.localStorage.getItem($t) || '');
                } catch (e) {
                    return '';
                }
            })() || e),
...
function Ca(e) {
    Mt = _a(e);
    try {
        localStorage.setItem(ht, JSON.stringify(Mt));
    } catch (e) {}
    return Mt;
}
function Sa() {
...
function tn(e, t) {
    const a = ta(t),
        ...
        { group: o, latest: s, details: r } = ja('operator'),
        l = String(r.station || '')
            .trim()
            .toLowerCase(),
...
function an(e, t) {
    const a = ta(t),
        ...
        { group: i, latest: o, details: s } = ja('kiosk'),
...
function nn(e, t) {
    const a = ta(t),
        ...
        { group: i, latest: o, details: s } = ja('display'),
        r = String(s.connection || 'live')
            .trim()
            .toLowerCase(),
        l = Ga(o);
...
function Nn(e, t) {
    ...
    const a = En(e?.ticketCode),
        n = En(e?.patientInitials),
        i = En(e?.queueType),
        o = En(e?.status),
...
function Mi(e = {}) {
    ...
    const o = 'mac' === n || 'win' === n || 'other' === n ? n : xt(),
...
function Gi(e) {
    (b((t) => ({ ...t, queue: { ...t.queue, ...e } })), zi(g()), Ei(Bi));
}
function Wi(e) {
...
function Eo(e = {}) {
    ...
    return (
        ...
        'queue' === g().ui?.activeSection && Ei(),
        t && n.active ? (Mo(a), !0) : n.active
    );
}
function Bo() {
    'visible' !== document.visibilityState ? Eo() : Mo('visibility');
}
function No() {
    ('undefined' != typeof document && 'hidden' === document.visibilityState) ||
        ('queue' === g().ui?.activeSection && Mo('focus'));
}
function Io() {
    'queue' === g().ui?.activeSection && Mo('online');
}
...
async function xo({ ticketId: e, action: t, consultorio: a }) {
    const n = Number(e || 0),
        i = xe(t);
    if (n && i)
...
function Ho() {
    (Me(), Bi('Accion sensible cancelada'));
}
function Uo() {
    const e = document.getElementById('queueSensitiveConfirmDialog'),
...
async function Fo(e) {
    ...
    if (t.length) {
        ...
        (xi(), Bi(`Bulk ${a} sobre ${t.length} tickets`));
    }
}
async function Ko(e) {
    const t = Number(e || 0);
...
async function zo() {
    ...
    (xi(), Bi(`Bulk reimpresion ${e.length}`));
}
var Vo = Object.freeze({
    __proto__: null,
    callNextForConsultorio: jo,
...
async function Jo(e) {
    ...
    if (
        ...
        return void (await jo(t.queue.stationConsultorio));
    const a = Ie(e.code),
        n = Ie(e.key),
        i = (function (e, t, a) {
            return (
    ...
    if (!o)
        return i
            ? (t.queue.oneTap && Wo(t) && (await Oo()),
              void (await jo(t.queue.stationConsultorio)))
            : void ((function (e, t) {
                  return (
                      'numpaddecimal' === e ||
                      'kpdecimal' === e ||
...
function xs() {
    const t = g(),
        ...
        o = Bs(Es(Ms(a, i.filter), i.search), i.sort);
    (l('#appointmentsTableBody', Ps(o)),
        ...
        (function (t, a, i) {
            ...
            (function (e) {
                const t = Ms(e, 'pending_transfer'),
                    a = Ms(e, 'upcoming_48h'),
                    n = Ms(e, 'no_show'),
                    i = Ms(e, 'triage_attention'),
                    o = e.filter(Ss);
                return {
...
function js(e) {
    (b((t) => ({ ...t, appointments: { ...t.appointments, ...e } })), xs());
}
function Rs(e) {
    js({ filter: hs(e) || 'all' });
}
...
const kr = {
    ...
    queue_call_next: async () => {
        (await cs('queue'), await jo(g().queue.stationConsultorio));
    },
};
async function qr(e) {
    const t = kr[e];
...
function Ar(e, t = {}) {
    ...
    b((n) => ({
        ...
        agent: {
            ...
            submitting: !1,
            syncing: !1,
            syncState: e?.session ? 'live' : 'idle',
            lastSyncAt: Number.isFinite(a) ? a : Date.now(),
            ...
            outbox: Array.isArray(e.outbox) ? e.outbox : [],
            health: e.health || null,
...
function Tr(e = g()) {
    ...
    if ('callbacks' === t) {
        ...
        const t = (function (e) {
                return Bs(
                    Es(
                        Ms(e.data.appointments || [], e.appointments.filter),
...
function Mr() {
    const a = g(),
        ...
        b = Array.isArray(o.outbox) ? o.outbox : [],
        y = !0 === a.auth?.authenticated,
        f = String(o.syncState || 'idle'),
        v =
            Number(o.lastSyncAt || 0) > 0
                ? i(new Date(o.lastSyncAt).toISOString())
    ...
    (r(
        ...
        o.lastError
            ...
            : 'idle' === c
              ? 'Sesion inactiva. Abre el copiloto para trabajar con contexto del admin.'
              : `Sesion operativa auditada con tools tipadas${'online' !== s ? ' en modo degradado' : ''}.`
    ),
        r(
        ...
        r(
            ...
            `${b.filter((e) => 'queued' === e.status).length} queued · ${b.length} total`
        ),
        r('#adminAgentRelayBadge', `relay ${s}`));
    const h = t('#adminAgentRelayBadge');
    (h instanceof HTMLElement && h.setAttribute('data-state', s),
        l(
            ...
            (function (t) {
                return t.length
                    ? t
                          ...
                          .map(
                              (t) =>
                                  `\n                <article class="admin-agent-list__item">\n                    <div class="admin-agent-list__line">\n                        <strong>${e(t.channel || t.tool || 'outbox')}</strong>\n                        <span class="admin-agent-badge" data-state="${e(t.status || 'queued')}">${e(t.status || 'queued')}</span>\n                    </div>\n                    <p>${e([t.template, t.message].filter(Boolean).join(' · '))}</p>\n                    <small>${e(i(t.createdAt || ''))}</small>\n                </article>\n            `
                          )
                          .join('')
                    : '<p class="admin-agent-empty">Sin salidas externas registradas.</p>';
            })(b)
        ));
    const k = t('#adminAgentPrompt');
    k instanceof HTMLTextAreaElement &&
        (k.disabled = !y || !0 === o.submitting);
    const q = t('#adminAgentSubmitBtn');
    q instanceof HTMLButtonElement &&
        ((q.disabled = !y || !0 === o.submitting),
        (q.textContent = o.submitting ? 'Procesando...' : 'Ejecutar'));
}
function Er() {
    (_r && (window.clearInterval(_r), (_r = 0)), (Cr = !1));
}
function Br() {
    (Er(),
        !0 === g().auth?.authenticated &&
            !0 === g().agent?.open &&
            g().agent?.session?.sessionId &&
            (_r = window.setInterval(() => {
                Nr({ silent: !0 }).catch(() => {});
            }, 15e3)));
}
async function Nr({ silent: e = !1 } = {}) {
    const t = g(),
        a = String(t.agent?.session?.sessionId || '');
    if (!a || !0 !== t.auth?.authenticated || !0 !== t.agent?.open || Cr)
        return null;
    ((Cr = !0),
        e || (Sr({ syncing: !0, syncState: 'syncing', lastError: '' }), Mr()));
    try {
        const e = await _('admin-agent-events', { query: { sessionId: a } }),
            t = Lr(e?.data) || e?.data || null;
        return (
            t
                ? Ar(t, { syncState: 'live' })
                : Sr({
...
async function Ir() {
    ...
    if (!0 !== e.auth?.authenticated)
        return (Er(), wr({ keepOpen: !0 === e.agent?.open }), Mr(), null);
    try {
        const t = await _('admin-agent-status'),
            a = Lr(t?.data) || t?.data || null;
        return (
            a?.session || a?.health
                ? (Ar(a), Br())
                : (Er(), wr({ keepOpen: !0 === e.agent?.open })),
            Mr(),
            a
        );
    } catch (e) {
...
function Fr(e) {
    return Ur(`${e?.date || ''}T${e?.time || '00:00'}:00`);
}
function Kr(e) {
    if (!e) return 'Sin fecha';
    const t = Math.round((e - Date.now()) / 6e4),
...
function Vr(e) {
    const {
        ...
        c = (function (e) {
            return e.filter((e) => {
                const t = Hr(e.paymentStatus || e.payment_status);
                return (
                    'pending_transfer_review' === t || 'pending_transfer' === t
                );
            }).length;
        ...
        u = (function (e) {
            return e.filter((e) => 'pending' === Hr(e.status)).length;
        })(n),
        d = (function (e) {
            return e.filter((e) => {
                if ('pending' !== Hr(e.status)) return !1;
                const t = (function (e) {
                    return Ur(e?.fecha || e?.createdAt || '');
                })(e);
                return !!t && Math.round((Date.now() - t) / 6e4) >= 120;
            }).length;
        })(n),
        p = (function (e) {
            return e.filter((e) => 'no_show' === Hr(e.status)).length;
        })(t),
        m = (function (e) {
            return e.length
                ? (
    ...
    ((function (e) {
                    ...
                    : a > 0
                      ...
                      : e > 0
                        ...
                        : n > 0
                          ...
                          : i?.item
                            ? `La siguiente atencion es ${i.item.name || 'sin nombre'} ${Kr(i.stamp).toLowerCase()}.`
        ...
        (function (e) {
            ...
            (r(
                ...
                r(
                    '#dashboardFlowStatus',
                    n?.item
                        ? `${Kr(n.stamp)} | ${n.item.name || 'Paciente'}`
                        : t > 0
                ...
                r(
                    ...
                    o > 0
                        ...
                        : n?.item
                          ? `Siguiente paciente: ${n.item.name || 'Paciente'} ${Kr(n.stamp).toLowerCase()}`
            ...
            (function (e) {
                ...
                return [
                    zr(
                        ...
                        'Abrir agenda',
                        n?.item
                            ? `Siguiente cita ${Kr(n.stamp).toLowerCase()}`
        ...
        (function (e) {
            ...
            (r('#funnelViewBooking', o(t.viewBooking || 0)),
                ...
                l(
                    '#funnelEntryList',
                    Dr(e.checkoutEntryBreakdown, 'entry', 'count')
                ),
                l(
                    '#funnelSourceList',
                    Dr(e.sourceBreakdown, 'source', 'count')
                ),
                l(
                    '#funnelPaymentMethodList',
                    Dr(e.paymentMethodBreakdown, 'method', 'count')
                ),
                l(
                    '#funnelAbandonList',
                    Dr(e.checkoutAbandonByStep, 'step', 'count')
                ),
                l(
                    '#funnelAbandonReasonList',
                    Dr(e.abandonReasonBreakdown, 'reason', 'count')
                ),
                l(
                    '#funnelStepList',
                    Dr(e.bookingStepBreakdown, 'step', 'count')
                ),
                l(
                    '#funnelErrorCodeList',
                    Dr(e.errorCodeBreakdown, 'code', 'count')
                ));
        })(t.funnel));
}
function Gr(e) {
...
function Xr() {
    const t = g(),
        ...
        n = (function (e) {
            return e.slice().sort((e, t) => Wr(t) - Wr(e));
        })(a),
        o = (function (e) {
            return e.length
                ...
                return t
                    .map((t) =>
                        (function (t, { featured: a = !1 } = {}) {
                            ...
                            return `\n        <article class="review-card${a ? ' is-featured' : ''}" data-rating="${e(String(n))}">\n            <header>\n                <div class="review-card-heading">\n                    <span class="review-avatar">${e(Yr(t.name || 'Anonimo'))}</span>\n                    <div>\n                        <strong>${e(t.name || 'Anonimo')}</strong>\n                        <small>${e(i(t.date || t.createdAt || ''))}</small>\n                    </div>\n                </div>\n                <span class="review-rating-badge" data-tone="${e(o)}">${e(Jr(n))}</span>\n            </header>\n            <p>${e(Zr(t.comment || t.review || ''))}</p>\n            <small>${e(s)}</small>\n        </article>\n    `;
                        })(t, {
                            featured:
                                a.item &&
                                Gr(t.name) === Gr(a.item.name) &&
                                Wr(t) === Wr(a.item),
                        })
                    )
                    .join('');
...
async function ml(e, t) {
    switch (e) {
        ...
        case 'queue-call-next':
            return (await jo(dl(t)), !0);
        case 'queue-release-station':
            return (await Do(dl(t)), !0);
...
async function yl(e, t) {
    switch (e) {
        ...
        case 'open-agent-panel':
            return (await Pr({ focus: !0 }), !0);
        case 'close-agent-panel':
            return (Er(), Sr({ open: !1 }), z(), Mr(), !0);
        case 'admin-agent-refresh':
            return (
                await Nr(),
                s('Sesion del agente sincronizada', 'info'),
                !0
            );
        case 'admin-agent-submit': {
            ...
            return (
                ...
                a?.refreshRecommended && (await tl(!1)),
                ...
                a = await (async function (e) {
                    ...
                    try {
                        const t = await _('admin-agent-approve', {
                            ...
                            n = t?.data || {},
                            i = Lr(n) || n?.session || null;
                        return (i && Ar(i), Br(), Mr(), n);
                    } catch (e) {
                        throw (
                            Sr({
                                submitting: !1,
        ...
        case 'admin-agent-cancel':
            return (
                await (async function () {
                    ...
                    if (!t) return (wr({ keepOpen: !0 }), Mr(), null);
                    (Sr({ submitting: !0, lastError: '' }), Mr());
                    try {
...
async function fl() {
    (!(function () {
        ...
        (function () {
            ...
            (e instanceof HTMLElement &&
                ...
                Object.entries(jr).forEach(([e, t]) => {
                    (Rr(e, t.hero, 'data-admin-section-hero'),
                        Rr(e, t.priority, 'data-admin-priority-rail'),
                        Rr(e, t.workbench, 'data-admin-workbench'),
                        Rr(e, t.detail, 'data-admin-detail-rail'));
                }));
        })(),
        ...
        (function () {
            const e = {
                    stationMode:
                        'locked' === Ie(S(ji, 'free')) ? 'locked' : 'free',
    ...
    var a;
    (e instanceof HTMLFormElement && e.addEventListener('submit', nl),
        (a = {
