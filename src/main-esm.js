import { createOnceTask, scheduleDeferredTask, loadDeferredModule } from '../js/loader.js';
import {
    resolveDeployAssetVersion,
    withDeployAssetVersion,
    debugLog,
} from '../js/utils.js';
import { initActionRouterEngine } from '../js/router.js';
import { initThemeMode } from '../js/theme.js';
import { changeLanguage, initEnglishBundleWarmup } from '../js/i18n.js';
import { state } from '../js/state.js';
import { bootstrapConsent, showConsentBanner, initGA4 } from '../js/cookies.js';
import {
...
import { initDataEngineWarmup } from '../js/data.js';
import {
    initBookingEngineWarmup,
    initBookingUiWarmup,
    markBookingViewed,
} from '../js/booking.js';
import { initReviewsEngineWarmup } from '../js/engagement.js';
import { initGalleryInteractionsWarmup } from '../js/gallery.js';
import {
...
} from './apps/chat/shell-esm.js';
import { initUiEffectsWarmup, initModalUxEngineWarmup } from '../js/ui.js';
import { initRescheduleEngineWarmup } from '../js/reschedule.js';
import { initSuccessModalEngineWarmup } from '../js/success-modal.js';
import { initEngagementFormsEngineWarmup } from '../js/engagement.js';
import { loadDeferredContent } from '../js/content-loader.js';
