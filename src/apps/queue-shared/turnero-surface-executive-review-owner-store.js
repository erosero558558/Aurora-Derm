...
const STORAGE_KEY = 'turneroSurfaceExecutiveReviewOwnerStoreV1';
const STORAGE_SCHEMA = 'turnero-surface-executive-review-owner-store/v1';
...
function normalizeEntry(entry = {}, fallbackScope = 'regional') {
    ...
    return {
        ...
        actor,
        owner: actor,
        role: toString(source.role, 'executive-review'),
...
export function createTurneroSurfaceExecutiveReviewOwnerStore(
    scope = 'regional',
    clinicProfile = null
) {
    ...
    return {
        ...
        add(entry = {}) {
            const nextEntry = normalizeEntry({
                ...
                role: entry.role || 'executive-review',
            });
...
export default createTurneroSurfaceExecutiveReviewOwnerStore;
