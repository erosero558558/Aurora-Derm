...
const STORAGE_KEY = 'turneroSurfaceOnboardingLedgerV1';
const STORAGE_SCHEMA = 'turnero-surface-onboarding-ledger/v1';
...
export function createTurneroSurfaceOnboardingLedger(
    scope = 'global',
    clinicProfile = null
) {
    const normalizedScope = toString(scope, 'global') || 'global';
