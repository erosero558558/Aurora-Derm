...
const ADMIN_CONTEXT_ACTIONS = {
    ...
    appointments: {
        ...
        actions: [
            {
                action: 'context-appointment-quick-filter',
                filterValue: 'today',
                icon: 'fa-calendar-day',
                label: 'Filtrar hoy',
            },
    ...
    callbacks: {
        ...
        actions: [
            {
                action: 'context-callback-quick-filter',
                filterValue: 'pending',
                icon: 'fa-phone',
                label: 'Pendientes',
            },
...
function attachGlobalListeners() {
    document.addEventListener('click', async (event) => {
        ...
        try {
            ...
            if (action === 'context-appointment-quick-filter') {
                event.preventDefault();
                applyAppointmentQuickFilter(
            ...
            if (action === 'context-callback-quick-filter') {
                event.preventDefault();
...
async function bootLegacyAdmin() {
    initAdminThemeMode();
...
export function bootLegacyAdminAuto() {
    if (!legacyBootPromise) {
        legacyBootPromise = bootLegacyAdmin();
    }
