...
test('prod smoke integra github.deployAlerts en el gate cron manual', () => {
    ...
    const requiredSnippets = [
        ...
        '[INFO] github.deployAlerts fetchOk=$githubDeployAlertsFetchOk repo=$GitHubRepo canonicalDeployMethod=$CanonicalDeployMethod forceTransportDeploy=$ForceTransportDeploy rawRelevantCount=$githubDeployAlertsRawRelevantCount relevantCount=$githubDeployAlertsRelevantCount advisoryRelevantCount=$githubDeployAlertsAdvisoryRelevantCount',
        'rawTransportCount=$githubDeployAlertsRawTransportCount transportCount=$githubDeployAlertsTransportCount advisoryTransportCount=$githubDeployAlertsAdvisoryTransportCount',
        'rawConnectivityCount=$githubDeployAlertsRawConnectivityCount connectivityCount=$githubDeployAlertsConnectivityCount advisoryConnectivityCount=$githubDeployAlertsAdvisoryConnectivityCount',
        ...
        '[WARN] github.deployAlerts advisory only under canonicalDeployMethod=$CanonicalDeployMethod forceTransportDeploy=$ForceTransportDeploy',
