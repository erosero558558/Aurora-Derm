...
const CHAT_HISTORY_STORAGE_KEY$1 = 'chatHistory';
const CHAT_HISTORY_TTL_MS$1 = 24 * 60 * 60 * 1000;
const CHAT_HISTORY_MAX_ITEMS$1 = 50;
const CHAT_CONTEXT_MAX_ITEMS$1 = 24;
...
function getChatUiEngineDeps() {
    return {
        ...
        historyStorageKey: CHAT_HISTORY_STORAGE_KEY$1,
        historyTtlMs: CHAT_HISTORY_TTL_MS$1,
        historyMaxItems: CHAT_HISTORY_MAX_ITEMS$1,
        contextMaxItems: CHAT_CONTEXT_MAX_ITEMS$1,
        debugLog,
    };
}
...
function getChatWidgetEngineDeps() {
    return {
        ...
        addUserMessage,
        processWithKimi,
        startChatBooking: startChatBooking$1,
    };
}
...
function sendQuickMessage$1(type) {
    runDeferredModule(
        loadChatWidgetEngine,
...
function getChatBookingEngineDeps() {
    return {
        ...
        trackEvent,
        escapeHtml,
        minimizeChatbot: minimizeChatbot$1,
        openPaymentModal,
        getCurrentLang,
...
function handleChatBookingSelection$1(value) {
    runDeferredModule(
        loadChatBookingEngine,
...
function handleChatDateSelect$1(value) {
    if (!value) return;
    runDeferredModule(
        loadChatBookingEngine,
        ...
        onModuleReady: (module) => {
            if (module && typeof module.init === 'function') {
                module.init({
                    ...
                    getChatHistory,
                    setChatHistory,
                    chatContextMaxItems: CHAT_CONTEXT_MAX_ITEMS$1,
...
function getActionRouterEngineDeps() {
    return {
        ...
        submitReschedule,
        toggleChatbot: toggleChatbot$1,
        sendChatMessage: sendChatMessage$1,
        handleChatBookingSelection: handleChatBookingSelection$1,
        sendQuickMessage: sendQuickMessage$1,
        minimizeChatbot: minimizeChatbot$1,
        startChatBooking: startChatBooking$1,
        handleChatDateSelect: handleChatDateSelect$1,
        selectService,
    };
}
...
async function loadChatSystem() {
    ...
    loadingPromise = (async () => {
        const { ChatEngine, ChatWidgetEngine, ChatUIEngine, ChatBookingEngine } = await import('./chat.bundle.js');
