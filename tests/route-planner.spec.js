...
test.describe('Hero stage V2', () => {
    test('editorial triggers switch the active story on home', async ({ page }) => {
    ...
    test('stage primary CTA can move directly into booking hooks', async ({ page }) => {
        await gotoPublicRoute(page, '/es/');
