...
if (!function_exists('payment_stripe_secret_key')) {
...
if (!function_exists('payment_stripe_publishable_key')) {
...
if (!function_exists('payment_stripe_webhook_secret')) {
...
if (!function_exists('transfer_proof_upload_dir')) {
...
if (!function_exists('transfer_proof_public_base_url')) {
...
if (!function_exists('ensure_transfer_proof_dir')) {
...
if (!function_exists('save_transfer_proof_upload')) {
